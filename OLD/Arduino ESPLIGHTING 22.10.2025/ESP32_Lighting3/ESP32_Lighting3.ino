...
#define LIGHTING_ID "lighting_3"    // lighting_1, lighting_2, lighting_3
#define FIRST_DRAWER 8             // PCB #1: 1, PCB #2: 4, PCB #3: 7
#define SECOND_DRAWER 9             // PCB #1: 2, PCB #2: 5, PCB #3: 8
#define ZONE_NUMBER 3               // PCB #1: 1, PCB #2: 2, PCB #3: 3
